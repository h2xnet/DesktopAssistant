...
// 定义公共消息区间
//
#ifndef PUBLIC_MESSAGE_START_TYPE
#define PUBLIC_MESSAGE_START_TYPE 1
#endif
...
// 欢迎消息
#define PUBLIC_MESSAGE_WELCOME_REQUEST  (PUBLIC_MESSAGE_START_TYPE + 0)
#define PUBLIC_MESSAGE_WELCOME_RESPONSE (PUBLIC_MESSAGE_START_TYPE + 1)

// 节点信息，主要是进程ID，用于IPC通信使用
#define PUBLIC_MESSAGE_NODE_REQUEST     (PUBLIC_MESSAGE_START_TYPE + 2)
#define PUBLIC_MESSAGE_NODE_RESPONSE    (PUBLIC_MESSAGE_START_TYPE + 3)
